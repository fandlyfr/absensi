...
const char *ssid = "hinet4G-8E62";  //ENTER YOUR WIFI SETTINGS
const char *password = "apabangsat";
//************************************************************************
String postData ; // post array that will be send to the website
String link = "http://192.168.8.141/absen/getdata.php"; //computer IP or the server domain
int FingerID = 1;     // The Fingerprint ID from the scanner 
uint8_t id;
//*************************Biometric Icons*********************************
